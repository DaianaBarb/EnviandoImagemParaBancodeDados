    ...
    public static void exibiImagemLabel(byte[] minhaimagem, javax.swing.JLabel label)
{
       ...
       //input pq ele vai recuperar a imagem cria um input com a imagem vinda do banco 
    //lendo a imagem do imput e trasformando em buferedImage para aparecer no label
        if(minhaimagem!=null)
        {
